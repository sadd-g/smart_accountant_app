...
export default function ItemsScreen() {
  ...
  return (
    <View style={[st.c, { paddingTop: insets.top }]}><StatusBar barStyle="light-content" />
      <ControlHeader title="الأصناف" count={items.length} onBack={() => router.back()} onAdd={() => { setEditMode(false); setSelectedItem(null); setFormData({ name: '', unit: 'قطعة', category: '', brand: '', warehouse: '', costPrice: '0', salePrice: '0', quantity: '0', minQuantity: '0' }); setShowModal(true); }} />
