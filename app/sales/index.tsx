...
export default function Index() {
  ...
  const items = [["👥","العملاء","/sales/customers"],["📄","فاتورة مبيعات","/sales/sales-invoice"],["🔄","مرتجع مبيعات","/sales/sales-return"],["👨‍💼","مندوبي المبيعات","/sales/reps"],["📊","ملخص المبيعات","/sales/summary"],["📋","عرض سعر","/sales/quotation"]];
  return (
    <View style={styles.container}><StatusBar barStyle="light-content"/>
      <View style={[styles.content,{paddingTop:insets.top}]}>
        <View style={styles.header}><TouchableOpacity onPress={()=>router.back()} style={styles.backBtn}><Text style={styles.backText}>←</Text></TouchableOpacity><Text style={styles.title}>💰 المبيعات والعملاء</Text><View style={{width:40}}/></View>
