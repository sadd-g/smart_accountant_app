...
export default function Screen() {
  ...
  return (
    <View style={[styles.c,{paddingTop:insets.top}]}><StatusBar barStyle="light-content"/>
      <View style={styles.h}><TouchableOpacity onPress={()=>router.back()} style={styles.b}><Text style={styles.bt}>←</Text></TouchableOpacity><Text style={styles.t}>📋 عرض سعر</Text><View style={{width:40}}/></View>
      <View style={styles.cc}><Text style={styles.i}>🚧</Text><Text style={styles.tt}>عرض سعر</Text><Text style={styles.st}>قيد التطوير</Text></View>
    </View>
  );
}
