...
export default function SalesReturnScreen() {
  ...
  const [formData, setFormData] = useState({ date: new Date().toISOString().split('T')[0], customerId: '', customerName: '', warehouseId: '', warehouseName: '', cashBoxId: '', cashBoxName: '', description: '', refNumber: '' });
  ...
  return (
    <View style={[st.c, { paddingTop: insets.top }]}><StatusBar barStyle="light-content" />
      <View style={st.h}><TouchableOpacity onPress={() => router.back()}><Text style={st.bt}>←</Text></TouchableOpacity><Text style={st.t}>مردود مبيعات</Text><TouchableOpacity style={st.ab} onPress={() => { setFormData({ date: new Date().toISOString().split('T')[0], customerId: '', customerName: '', warehouseId: '', warehouseName: '', cashBoxId: '', cashBoxName: '', description: '', refNumber: '' }); setLines([{ id: '1', itemId: '', itemName: '', unit: 'قطعة', qty: '0', price: '0', total: '0' }]); setShowModal(true); }}><Text style={st.atx}>+</Text></TouchableOpacity></View>
