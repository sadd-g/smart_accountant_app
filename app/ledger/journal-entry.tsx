...
export default function JournalEntryScreen() {
  ...
  return (
    <View style={[st.c, { paddingTop: insets.top }]}><StatusBar barStyle="light-content" />
      <View style={st.h}><TouchableOpacity onPress={() => router.back()}><Text style={st.bt}>←</Text></TouchableOpacity><Text style={st.t}>القيود اليومية</Text><TouchableOpacity style={st.ab} onPress={() => setShowModal(true)}><Text style={st.atx}>+</Text></TouchableOpacity></View>
